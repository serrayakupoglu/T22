...
class AnotherUserFollowingsPage extends StatefulWidget {
  final String currentUserName;
  final VoidCallback onUpdate;
  const AnotherUserFollowingsPage({Key? key, required this.currentUserName, required this.onUpdate})
      : super(key: key);

  @override
  State<StatefulWidget> createState() => _AnotherUserFollowingsPageState();
}

class _AnotherUserFollowingsPageState extends State<AnotherUserFollowingsPage> {
      ...
      body: FutureBuilder<User?>(
        ...
        builder: (context, userSnapshot) {
          if (userSnapshot.connectionState == ConnectionState.waiting) {
            ...
            final List<String> data = userSnapshot.data!.followings;

...
class SongBoxWithoutIcon extends StatelessWidget {
  ...
  const SongBoxWithoutIcon({super.key, required this.songName, required this.artistName, this.onIconPressed});
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
                ...
                icon: Icon(
                  Icons.more_horiz,
                  color: Color(kSearchBoxMoreIconColor).withOpacity(0),
                )
            )
          ],
        )
